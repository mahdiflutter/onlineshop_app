...
Future<void> initGetIt() async {
  ...
  locator.registerFactory<IProductGalleryDatasource>(
    () => ProductGalleryRemote(),
  );
  locator.registerFactory<IProductsByCategoryDataSource>(
    () => ProductsByCategoryRemote(),
  );
  ...
  locator.registerFactory<IProductByCategoryRepository>(() => ProductByCategoryRepository());
}
